...
exports.DEMO_PREDICTION_POOL = exports.DEMO_LEADERBOARD = exports.DEMO_SQUADS = exports.DEMO_COMPETITION = void 0;
const NOW = Math.floor(Date.now() / 1000);
const ROUND_END = NOW + 2 * 24 * 3600 + 14 * 3600; // ~2d 14h from now
exports.DEMO_COMPETITION = {
    competition_id: 1,
...
exports.DEMO_LEADERBOARD = exports.DEMO_SQUADS.map((s, i) => ({
    rank: i + 1,
...
exports.DEMO_PREDICTION_POOL = {
    totalStaked: 12400,
    squads: exports.DEMO_SQUADS.slice(0, 5).map((s, i) => ({
